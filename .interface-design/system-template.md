...
|----------|-----------|------|
| (example) Borders-only depth | Dashboard tool, users want density. | YYYY-MM-DD |
| (example) 4px spacing base | Tight enough for data tables, divisible by common UI sizes | YYYY-MM-DD |
